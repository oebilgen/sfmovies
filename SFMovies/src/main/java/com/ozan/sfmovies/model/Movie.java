...
public class Movie implements Serializable
{
	...
	{
		return "Movie [id=" + this.id + ", actor1=" + this.actor1 + ", actor2="
				+ this.actor2 + ", actor3=" + this.actor3 + ", director="
				+ this.director + ", distributor=" + this.distributor
				+ ", funFacts=" + this.funFacts + ", locations="
				+ this.locations + ", productionCompany="
				+ this.productionCompany + ", releaseYear=" + this.releaseYear
				+ ", title=" + this.title + ", writer=" + this.writer + "]";
	}
	...
	public int hashCode()
	{
		...
		int result = 1;
		result = prime * result
				+ (this.actor1 == null ? 0 : this.actor1.hashCode());
		result = prime * result
				+ (this.actor2 == null ? 0 : this.actor2.hashCode());
		result = prime * result
				+ (this.actor3 == null ? 0 : this.actor3.hashCode());
		result = prime * result
				+ (this.director == null ? 0 : this.director.hashCode());
		result = prime * result
				+ (this.distributor == null ? 0 : this.distributor.hashCode());
		result = prime * result
				+ (this.funFacts == null ? 0 : this.funFacts.hashCode());
		result = prime * result + (this.id == null ? 0 : this.id.hashCode());
		result = prime * result
				+ (this.locations == null ? 0 : this.locations.hashCode());
		result = prime
				* result
				+ (this.productionCompany == null ? 0 : this.productionCompany
						.hashCode());
		result = prime * result
				+ (this.releaseYear == null ? 0 : this.releaseYear.hashCode());
		result = prime * result
				+ (this.title == null ? 0 : this.title.hashCode());
		result = prime * result
				+ (this.writer == null ? 0 : this.writer.hashCode());
		return result;
	}
